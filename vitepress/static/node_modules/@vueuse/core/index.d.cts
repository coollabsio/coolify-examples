...
import { Fn, MaybeRef, MaybeRefOrGetter, Awaitable, ConfigurableEventFilter, ConfigurableFlush, RemovableRef, EventHookOn, Pausable, IsAny, Arrayable, ReadonlyRefOrGetter, UseIntervalFnOptions, UseTimeoutFnOptions } from '@vueuse/shared';
export * from '@vueuse/shared';
import * as vue from 'vue';
import { Ref, InjectionKey, ComputedRef, DefineComponent, Slot, ComponentObjectPropsOptions, TransitionGroupProps, ComponentPublicInstance, WatchOptionsBase, Component, ShallowRef, WritableComputedRef, UnwrapRef, WatchOptions, UnwrapNestedRefs, MaybeRefOrGetter as MaybeRefOrGetter$1, App, WatchSource, ToRefs, StyleValue } from 'vue';
...
declare function useDisplayMedia(options?: UseDisplayMediaOptions): {
    ...
    stop: () => void;
    enabled: Ref<boolean, boolean> | vue.ShallowRef<boolean, boolean> | vue.WritableComputedRef<boolean, boolean> | vue.ShallowRef<true, true> | vue.ShallowRef<false, false>;
};
...
declare function usePointerLock(target?: MaybeElementRef, options?: UsePointerLockOptions): {
    isSupported: vue.ComputedRef<boolean>;
    element: vue.Ref<MaybeElement, MaybeElement>;
    triggerElement: vue.Ref<MaybeElement, MaybeElement>;
...
interface UseRafFnOptions extends ConfigurableWindow {
     ...
     * @default undefined
     */
    fpsLimit?: MaybeRefOrGetter$1<number>;
    /**
